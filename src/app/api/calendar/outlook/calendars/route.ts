...
// GET /api/calendar/outlook/calendars - List user's Outlook calendars
export async function GET(req: NextRequest) {
  return withErrorHandler(async (req) => {
    ...
    try {
      const calendars = await outlookCalendarService.listCalendars(integration)
...
// POST /api/calendar/outlook/calendars - Set target calendar for sync
